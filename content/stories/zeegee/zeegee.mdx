...
<Image src={working} caption="Alan, Max, and Daniel hacking away. Daniel was our most capable Unity developer, and Max is a skilled artist and modeler. Alan is a VR enthusiast and entrepreneur and helped do lots of the testing, in addition to his large amounts of energy and passion ⚡️" />
...
import zeegee from './zeegee.jpg'

<Image src={zeegee} caption="Team ZeeGee all grins at the end of an excellent weekend 😊" />
