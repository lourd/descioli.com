...
<Image src={shadows} maxWidth={550} caption="Arrows that I shot into my coffee table." />
...
import maxandnoah from './max-and-noah.jpg'

<Image src={maxandnoah} caption="Recording sound effects with Max and Noah one Saturday night. Audio design tools have such cool visualizations." />
...
import playtest from './playtest.mp4'

<Video src={playtest} caption="This was the first play video I got after putting out the beta. I could not stop smiling the first time I saw it, I watched it at least three times in a row 😄 Kids are the absolute best." maxWidth={400} />
...
import usersMap from './usersMap.png'

<Image src={usersMap} caption="A map of the places around the world where people are playing Out Here Archery" />
...
import firstMonthFunnel from './firstMonthFunnel.png'

<Image src={firstMonthFunnel} caption="The game completion funnel from the first month showing the data about where players are dropping off. It's not great." />
...
<Image src={chest} caption="A sparkling treasure chest is revealed after beating the first three challenges, with the other four challenge balloons appearing behind it as semi-transparent." maxWidth={550} />
