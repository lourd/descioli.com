...
<Image src={greenhousetrip} caption="Nick Ambrogi, Jamie Byron, Dave Bowker, and me (behind the camera) on a customer research trip from January 2014 interviewing a New England greenhouse farmer." />
...
<Image src={team2014} caption="The Grove team hanging out for a picture in the under-construction research farm, taken January 2014. I bet you can guess which person is Chad." />
...
<Image src={sketchone} caption="This beautiful sketch and the company's logo were created by the talented Elliot Ouchterlony." />
...
<Image src={sensors} caption="Sensor hubs that Nick designed that Gabe and Jamie brought to an agriculture conference in Dubai. The most beautiful empty boxes you've ever seen." maxWidth={450}/>
...
<Image src={bkbteam} caption="Some of the team showing off our hydroponic garden prototype at Brooklyn Boulders, the nearby climbing gym where we provided free memberships." />
...
<Image src={forgegrove} caption="I loved sitting by our early prototypes of the EA Ecosystem in public venues watching how people interacted with them. One learning from doing so was that the aquarium needed to go in the bottom sections of a system so kids can look on more easiliy." />
...
<Image src={carsnow} caption="Oh, the joy of shoveling out the car from huge mounds of snow every morning." />
...
<Image src={gurf} caption="Our largest aquaponics system in the GURF, bursting with all kinds of basil, mustard greens, tomatoes, kale and more" />
...
<Image src={softwaregroovin} caption="Charles, me, and Steph, seen here on a completely normal day in the office." />
...
<Image src={eamobo} caption="The motherboard for the Early Adopter Ecosystem." maxWidth={500}/>
...
<Image src={meteor} caption="Originally made for Worldwide Meteor Day 2014 😬 😅" alt="Meteor 😬 😅" />
...
<Image src={board} caption="The only project management tool that ever stuck — a physical whiteboard" />
...
<Image src={eaDashboard} caption="The dashboard for an Early Adopter Ecosystem in the mobile web app" maxWidth={400}/>

import chens from './chens.jpg'

<Image src={chens} caption="Delivering Grove #15 to the Chen family." maxWidth={600}/>
...
<Image src={citygrowersday} caption="The Grove team circa June 2015, after working a day at the City Growers farm in Dorchester run by Nataka Crayton-Walker and Bobby Walker." />
...
<Image src={band} caption="Karl and Siegel tearin' it up on stage at our Kickstarter launch party." />
...
<Image src={kickstarter} caption="When we were Kickstarter's project of the day" />
...
<Image src={learningswift} caption="The day we decided to make a native app I went out and got us two six packs and we spent the rest of the afteroon drinking away our JavaScript sorrows and watching videos teaching us Swift." />
...
<Image src={pcbStork} caption="The first motherboard from the hardware team, delivered on a platter with a bottle of wine. If you're going to work yourself to the bone, you have to at least have fun with it." />

import threeTowerInsta from './threeTowerInsta.jpg'

<Image src={threeTowerInsta} alt="Coming captione to my own grove that was bursting with life didn't hurt" maxWidth={550}/>
...
<Image src={appStore} caption="Working within walled-garden ecosystems is frustrating compared to the unrestrained world of web apps. But there's still something thrilling about seeing your app in the App Store." maxWidth={400}/>
...
<Image src={pollan} caption="The time Elias, Steph, and I handed out fliers at an event with Michael Pollan and pitched him on getting a grove"/>
...
<Image src={ritzdelivery} caption="Celebrating the delivery of Ecosystem #1 with Stephen and Lizette Ritz" />
...
<Image src={meGabeStephen} caption="Me, Stephen, and Gabe at the grand opening of the National Health and Wellness Center at C.S. 55" />
...
<Image src={salesboard} caption="The sales team's whiteboard when we hit 600k" />
