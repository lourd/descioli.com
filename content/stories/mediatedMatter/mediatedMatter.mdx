...
import meandstevepic from './meandsteve.jpg'

<Image src={meandstevepic} caption="Me and Steven cheesin' it up in front of the test bed after a successful experiment 🤓" />
...
import experimentPic from './earlyexperiment.jpg';

<Image src={experimentPic} caption="One of our first successful experiments using the arm and the foam canister in tandem" />
...
<Image src={closeup} caption="A close up on one of the printed shells" />
...
import lightcloseup from './lightcloseup.jpg'

<Image src={lightcloseup} caption="Light art made with long exposure photography and the robotic arm. I love looking closely at the paths the arm makes, its complex planning laid out so neatly" />
