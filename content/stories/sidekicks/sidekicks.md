...
The core idea that the Suskind's practiced with Owen and that Sidekicks built on was [affinity therapy](http://www.autistes-et-cliniciens.org/Affinity-Therapy-The-Return-of-a-Psychodynamic-Approach-to-the-Treatment-of). In simple terms, affinity therapy is meeting an autistic child where they're at and building from there. It is using their interests and passions as vessels for communicating with them. For Owen and the Suskind's, they used his overwhelming love for Disney and animated movies to engage with him. For other children, that passion may be anything from trains to Jewish comedians to ski lifts (all actual affinities of children I met).

Affinity therapy may seem like a simple and agreeable concept, but it isn't in the world of autism therapy. Currently, the most widespread therapy for autistic children is applied behavior analysis, or ABA. It centers around removing the autistic behaviors from a child. Its base assumption is that the autistic behaviors of the child are bad and must be stamped out so the child can develop as a "normal" child. It seeks to fundamentally modify the child's behavior through hundreds of hours of intensive operant conditioning. Under the ABA school of thought, autistic children should be limited in how much time they spend engaging with their "obsessions" because it triggers their autistic behaviors. The belief is that an autistic child can't develop if they're stimming from being in their superhero costume or looking through their kaleidoscope at shiny objects.

Taking away distracting things may seem reasonable for a neurotypical person, but for an autistic person it can greatly hinder their ability to be comfortable or focused. Removing the objects and subjects that bring them pleasure and make them content can throw them into a deeply isolated or dysfunctional state. The Suskind's figured out how to use Owen's affinity to tap into his person and potential. Sidekicks was founded to turn that concept into a product, making software that would make it easier for parents and therapists everywhere to connect with autistic children through their passions.
...
When I joined Sidekicks the product was a video and messaging system. On one side of a conversation was a child talking to an animated avatar through a mobile app. On the other side was their parent or a therapist talking back through a desktop web app. The adult could hear the child's voice and type replies for the avatar to say, or send videos from our curated library of movie clips.
...
I spent many hours listening to the recordings of these sessions, trying to empathize and learn the nuance of communication that enabled these children to connect. Hearing a child lose control because of a design change, an abrupt application crash, or other bug also brought a new level of attention and caution to my coding and design.

https://www.youtube.com/watch?v=Cb7BGKtxsBk

## Fizbit

There was also an automated sidekick that children could talk with. We called this chatbot Fizbit. Through Fizbit the company dabbled in natural language processing and machine learning.
...
![The commit where I swapped out the old application for the new one. There's nothing quite like removing 12 million lines of code! (The number is so high because the old application kept its third party dependencies in source control.)](commit.png)
...
Although we had a great new web application, product engagement remained poor. Our main obstacle was the fact that our iOS app was not available in the App Store. When the team submitted the app in September, Apple rejected it over copyright concerns due to the movie clips it contained. While we asserted that the usage should fall under [fair use](https://en.wikipedia.org/wiki/Fair_use) because of the short duration of the clips, Apple wanted explicit permission from each of the content owners. (The App Store is Apple's own domain, not a court of law. They dictate the rules.) For months we tried to work around this by [routing users through TestFlight](https://www.youtube.com/watch?v=AJBavfVtES8), Apple's program for beta testing applications. We went as far as to call interested customers and be with them through the entire signup process. In some cases it took as long as an **hour** for a customer to get from the first page of registration to having their first chat. TestFlight was not tenable.

# YouTube

In March, at the behest of one of our investors, we decided to drastically change the product in order to get into the App Store. We removed our curated content and in its place put YouTube search. We offerred a handful of search suggestions, but parents were now on their own to figure out what content they wanted to show their children, and what about it they wanted to discuss. (It was during this time that I was first exposed to the [strange universe of YouTube content for children](https://medium.com/@jamesbridle/something-is-wrong-on-the-internet-c39c471271d2).)

After making that change, the app was accepted into the App Store within hours.

# Losing steam

Although we were in the App Store, our user base started to dwindle. Users were not taking to the new YouTube system. We had also recently ended the Coach on Demand service, which was the source of the majority of our recurring users. The company had only ever intended for it to be a temporary pilot program. We were essentially subsidizing therapy, and could no longer afford to do so.

Towards the end of my time at Sidekicks, decisions were made to change the product even more. In the new version, the child also assumed an avatar and we dropped the pretense of talking to a sidekick. It resembled more of a traditional chat application instead of the specialized tool that we had previously created.
