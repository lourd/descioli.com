    ...
    <div className="flex flex-col justify-center h-full w-full max-w-[520px]">
      ...
      <nav className="mt-8 flex flex-col gap-[5px]">
        <div>
          <Link
            href="/blog"
            className="block -ml-1 px-2 py-1 rounded-sm text-link text-2xl md:text-3xl hocus:bg-muted transition-colors duration-200"
          >
            <span className="inline-block w-10">📰</span>
            <span>My blog</span>
          </Link>
          <p className="text-foreground-gray ml-[46px] leading-normal text-sm">
            Read my latest{" "}
        ...
        <div>
          ...
          <div className="text-foreground-gray ml-[46px] leading-normal text-sm">
            Virtually speaking
          </div>
        </div>
        <div>
